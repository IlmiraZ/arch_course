...
import ru.ilmira.serv.ProductService;
import ru.ilmira.serv.dto.ProductDto;
...
public class ProductResource {
    ...
    public ErrDto notFoundExceptionHandler(NotFoundException ex) {
        return new ErrDto(ex.getMessage());
    }

    @ExceptionHandler
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ErrDto illegalArgumentException(IllegalArgumentException ex) {
        return new ErrDto(ex.getMessage());
    }
}
